...
reinstall:
	@curl -sO https://raw.githubusercontent.com/rconjoe/gqs/master/git-quick-stats
	@curl -sO https://raw.githubusercontent.com/rconjoe/gqs/master/git-quick-stats.1
	$(MAKE) install
	@$(TASK_DONE)
